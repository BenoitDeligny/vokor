...
import games.vokor.gaming.domain.heroes.Ability.Companion.agility
import games.vokor.gaming.domain.heroes.Ability.Companion.perception
import games.vokor.gaming.domain.heroes.Ability.Companion.strength
import games.vokor.gaming.domain.fighters.HealthPoints.Companion.hp
import games.vokor.gaming.domain.fighters.Might
import games.vokor.gaming.domain.heroes.HeroesFactory.aHero
import games.vokor.gaming.domain.heroes.HeroesFactory.aRandomHeroInNormalMode
import games.vokor.gaming.domain.heroes.HeroesFactory.withHealthPoints
import games.vokor.gaming.domain.heroes.HeroesFactory.withInventory
import games.vokor.gaming.domain.heroes.HeroesFactory.withItem
import games.vokor.gaming.domain.heroes.IdentityFactory.aHeroIdentity
import games.vokor.gaming.domain.items.Enhancements
import games.vokor.gaming.domain.items.Enhancements.Power.Companion.power
import games.vokor.gaming.domain.items.Enhancements.Protection.Companion.protection
import games.vokor.gaming.domain.items.Item.*
import games.vokor.gaming.domain.items.Item.Weapon.WeaponType.ONE_HANDED
import games.vokor.gaming.domain.items.Item.Weapon.WeaponType.TWO_HANDED
